...
export function* watcherSaga() {
  ...
  yield takeLatest(types.GROUPME_MESSAGES_REQUESTED, messagesRequestSaga)
}
...
function* messagesRequestSaga({ payload: { token, group_id, before_id = undefined, after_id=undefined, limit = undefined }}) {
  try {
